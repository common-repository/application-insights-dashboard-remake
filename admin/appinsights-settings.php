	    	...
	    	<form name="appinsights_form" method="post"
				...
				<table class="options">
					...
					if ($options['appinsights_token']) {
						...
						<tr>
							<td colspan="2">
								<h2><?php _e('Application Insights Settings'); ?></h2>
							</td>
						</tr>
						<tr>
							<td> 
								<label for="options[instrumentation_key]"><?php _e('Instrumentation Key:'); ?></label>
							</td>
							<td>
								<input type="text" name="options[instrumentation_key]" 
								        value="<?php echo esc_attr($options['instrumentation_key']); ?>" 
								        size="40">
							</td>
						</tr>
						<tr>
							<td colspan="2">				       
								<input type="submit" name="save_instrumentation_key" class="button button-secondary" id="authorize" value="Save Changes" /> 
							</td>
						</tr>
						<!-- -End -->
                        <?php 
